...
async def cb_handler(client: Bot, query: CallbackQuery):
    ...
    if data == "about":
        await query.message.edit_text(
            text = f"<b>○ Creator : <a href='<b>\n○  ᴄʀᴇᴀᴛᴏʀ : <a href='https://t.me/TheKaiChisaki'>X Ʌ I D Ǝ Ͷ</a>\n○  ʟᴀɴɢᴜᴀɢᴇ : <code>Eng Sub & Dub</code>\n○  Main Channel : <a href=https://t.me/thecosmosx>TheCosmos</a>\n○  Anime Channel : <a href=https://t.me/animexcosmos> Anime Cosmos</a>\n</b>",
